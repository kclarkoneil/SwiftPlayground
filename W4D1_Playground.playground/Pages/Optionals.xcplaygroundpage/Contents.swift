 ...
 */
var testNewString: String? = "cheers"
testNewString = nil
...
var numberString = "7"
let number:Double = 7
var intValue = Double(numberString)
var result = intValue! * number
/*:
 - Experiment:
 ...
 */
var anotherArray = [7,8,9,99,40,33,34]
let newInt: Int? = anotherArray.first
if let newvar = newInt {
    print("\(newvar)")
}
else {
    print("not an int")
...
var indexOf9: Int? = anotherArray.index(of: 9)
if let existence = indexOf9 {
    print ("\(existence)")
}
else {
    print ("9 is not an element")
}
/*:
 - Callout(Challenge):
